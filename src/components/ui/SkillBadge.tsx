  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        align="start"
        sideOffset={10}
        className="max-w-72 border border-slate-500/25 bg-slate-950 px-3 py-2 text-left text-xs leading-5 text-slate-100 shadow-2xl shadow-black/40"
      >
        {detail}
      </TooltipContent>
    </Tooltip>
