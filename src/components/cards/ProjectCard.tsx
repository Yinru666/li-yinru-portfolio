  ...
  return (
    ...
    >
      ...
      <div className="flex h-full min-w-0 flex-col p-5">
        ...
        <h3 className="mt-3 min-w-0 break-words text-lg font-semibold leading-snug text-slate-50">
          {project.title}
        </h3>
