...
export function TimelineInteractive({ events }: TimelineInteractiveProps) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(280px,0.65fr)]">
      <div className="relative grid gap-3 before:absolute before:left-4 before:top-4 before:h-[calc(100%-2rem)] before:w-px before:bg-slate-500/25 sm:grid-cols-2 sm:before:hidden">
        {events.map((event) => {
